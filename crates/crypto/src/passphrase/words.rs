...
//! 共 1176 个单词，用于生成 12 词助记词

pub const NRCS_WORDS: &[&str] = &[
...
pub const WORD_COUNT: usize = NRCS_WORDS.len();
...
mod tests {
    ...
    #[test]
    fn test_word_count() {
        assert_eq!(WORD_COUNT, 1626);
    }

    #[test]
    fn test_words_unique() {
        use std::collections::HashSet;
        let set: HashSet<&&str> = NRCS_WORDS.iter().collect();
