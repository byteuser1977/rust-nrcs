...
(
 ...
 has_control_phasing TINYINT(1) DEFAULT FALSE NOT NULL,
...
(
 ...
 height INTEGER NOT NULL,
 latest TINYINT(1) DEFAULT TRUE NOT NULL,
 has_image TINYINT(1) DEFAULT FALSE NOT NULL
);
...
(
 ...
 encrypted_is_text TINYINT(1) DEFAULT FALSE,
...
(
 ...
 goods BLOB,
 goods_nonce BLOB,
 goods_is_text TINYINT(1) DEFAULT TRUE NOT NULL,
 refund_note BLOB,
 refund_nonce BLOB,
 has_feedback_notes TINYINT(1) DEFAULT FALSE NOT NULL,
 has_public_feedbacks TINYINT(1) DEFAULT FALSE NOT NULL,
...
(
 rescan TINYINT(1) DEFAULT FALSE NOT NULL,
 height INTEGER DEFAULT 0 NOT NULL,
 validate TINYINT(1) DEFAULT FALSE NOT NULL
);
...
(
 ...
 transaction_index SMALLINT NOT NULL,
 phased TINYINT(1) DEFAULT FALSE NOT NULL,
 attachment_bytes BLOB,
 version SMALLINT NOT NULL,
 has_message TINYINT(1) DEFAULT FALSE NOT NULL,
 has_encrypted_message TINYINT(1) DEFAULT FALSE NOT NULL,
 has_public_key_announcement TINYINT(1) DEFAULT FALSE NOT NULL,
 has_prunable_message TINYINT(1) DEFAULT FALSE NOT NULL,
 has_prunable_attachment TINYINT(1) DEFAULT FALSE NOT NULL,
 ec_block_height INTEGER DEFAULT NULL,
 ec_block_id BIGINT DEFAULT NULL,
 has_encrypttoself_message TINYINT(1) DEFAULT FALSE NOT NULL,
 has_prunable_encrypted_message TINYINT(1) DEFAULT FALSE NOT NULL,
...
/* 如果是历史库需要增加此字段
alter table asset add column has_control_phasing TINYINT(1) DEFAULT FALSE NOT NULL
*/
/*
