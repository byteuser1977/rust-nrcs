...
(
 id BIGINT NOT NULL,
 balance BINARY LARGE OBJECT NOT NULL,
 height INTEGER NOT NULL
);
...
(
 ...
 previous_block_hash BINARY LARGE OBJECT,
 cumulative_difficulty BINARY LARGE OBJECT NOT NULL,
 base_target BIGINT NOT NULL,
 next_block_id BIGINT,
 height INTEGER NOT NULL,
 generation_signature BINARY LARGE OBJECT NOT NULL,
 block_signature BINARY LARGE OBJECT NOT NULL,
 payload_hash BINARY LARGE OBJECT NOT NULL,
...
(
 ...
 holding_id BIGINT,
 min_balance_model SMALLINT,
 hashed_secret BINARY LARGE OBJECT,
 algorithm SMALLINT,
 height INTEGER NOT NULL
);
...
(
 db_id BIGINT AUTO_INCREMENT PRIMARY KEY NOT NULL,
 transaction_id BIGINT NOT NULL,
 linked_full_hash BINARY LARGE OBJECT NOT NULL,
...
(
 ...
 sender_id BIGINT NOT NULL,
 recipient_id BIGINT,
 message BINARY LARGE OBJECT,
 message_is_text BOOLEAN NOT NULL,
 is_compressed BOOLEAN NOT NULL,
 encrypted_message BINARY LARGE OBJECT,
...
(
 db_id BIGINT AUTO_INCREMENT PRIMARY KEY NOT NULL,
 account_id BIGINT NOT NULL,
 public_key BINARY LARGE OBJECT,
 height INTEGER NOT NULL,
 latest BOOLEAN DEFAULT TRUE NOT NULL,
...
(
 ...
 note BINARY LARGE OBJECT,
 nonce BINARY LARGE OBJECT,
 timestamp INTEGER NOT NULL,
 pending BOOLEAN NOT NULL,
 goods BINARY LARGE OBJECT,
 goods_nonce BINARY LARGE OBJECT,
 goods_is_text BOOLEAN DEFAULT TRUE NOT NULL,
 refund_note BINARY LARGE OBJECT,
 refund_nonce BINARY LARGE OBJECT,
...
(
 db_id BIGINT AUTO_INCREMENT PRIMARY KEY NOT NULL,
 id BIGINT NOT NULL,
 feedback_data BINARY LARGE OBJECT NOT NULL,
 feedback_nonce BINARY LARGE OBJECT NOT NULL,
 height INTEGER NOT NULL,
 latest BOOLEAN DEFAULT TRUE NOT NULL
);
...
(
 ...
 data_transaction_full_hash BINARY LARGE OBJECT,
 height INTEGER NOT NULL,
 latest BOOLEAN DEFAULT TRUE NOT NULL
);
...
(
 ...
 amount BIGINT NOT NULL,
 fee BIGINT NOT NULL,
 full_hash BINARY LARGE OBJECT NOT NULL,
 height INTEGER NOT NULL,
 block_id BIGINT NOT NULL,
 ...
 sender_id BIGINT NOT NULL,
 block_timestamp INTEGER NOT NULL,
 referenced_transaction_full_hash BINARY LARGE OBJECT,
 transaction_index SMALLINT NOT NULL,
 phased BOOLEAN DEFAULT FALSE NOT NULL,
 attachment_bytes BINARY LARGE OBJECT,
...
(
 ...
 transaction_bytes BINARY LARGE OBJECT NOT NULL,
 height INTEGER NOT NULL,
...
(
 ...
 poll_id BIGINT NOT NULL,
 voter_id BIGINT NOT NULL,
 vote_bytes BINARY LARGE OBJECT NOT NULL,
 height INTEGER NOT NULL
);
...
(
 ...
 contract_transaction_full_hash BINARY LARGE OBJECT,
 height INTEGER NOT NULL,
 latest BOOLEAN DEFAULT TRUE NOT NULL
);
...
(
 ...
 order_full_hash BINARY LARGE OBJECT NOT NULL,
 match_id BIGINT NOT NULL,
 match_full_hash BINARY LARGE OBJECT NOT NULL
);
...
(
 db_id BIGINT AUTO_INCREMENT PRIMARY KEY NOT NULL,
 hashed_secret BINARY LARGE OBJECT NOT NULL,
 hashed_secret_id BIGINT NOT NULL,
 algorithm SMALLINT NOT NULL,
 transaction_full_hash BINARY LARGE OBJECT,
 transaction_id BIGINT NOT NULL,
 chain_id INTEGER NOT NULL,
 finish_height INTEGER NOT NULL,
 height INTEGER NOT NULL
