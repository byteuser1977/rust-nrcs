...
(
    ID bigint NOT NULL,
    BALANCE binary(2147483647) NOT NULL,
    HEIGHT integer NOT NULL
);
...
(
    ...
    SETTER_ID bigint,
    PROPERTY varchar(2147483647) NOT NULL,
...
(
    ...
    ID bigint NOT NULL,
    ACCOUNT_ID bigint NOT NULL,
    ALIAS_NAME varchar(2147483647) NOT NULL,
    ALIAS_NAME_LOWER varchar(2147483647) DEFAULT 'LOWER(ALIAS_NAME)' NOT NULL,
    ALIAS_URI varchar(2147483647) NOT NULL,
    TIMESTAMP integer NOT NULL,
    HEIGHT integer NOT NULL,
    LATEST boolean DEFAULT TRUE NOT NULL
);
...
(
    ...
    CUMULATIVE_DIFFICULTY binary(2147483647) NOT NULL,
...
CREATE INDEX IF NOT EXISTS BUY_OFFER_RATE_HEIGHT_IDX ON BUY_OFFER (RATE DESC, CREATION_HEIGHT);
...
(
    ...
    ACCOUNT_ID bigint NOT NULL,
    NAME varchar(2147483647) NOT NULL,
    NAME_LOWER varchar(2147483647) DEFAULT 'LOWER(NAME)' NOT NULL,
...
(
    DB_ID bigint  AUTO_INCREMENT PRIMARY KEY NOT NULL,
    TAG varchar(2147483647) NOT NULL,
...
(
    ...
    URIS varchar(2147483647),
    HEIGHT integer,
    LATEST boolean
);
CREATE TABLE IF NOT EXISTS PEER
(
    ADDRESS varchar(2147483647) PRIMARY KEY NOT NULL,
...
(
    ...
    HOLDING_ID bigint,
    MIN_BALANCE_MODEL tinyint,
    HASHED_SECRET binary(2147483647),
    ALGORITHM tinyint,
    HEIGHT integer NOT NULL
);
...
(
    ...
    ENCRYPTED_MESSAGE binary(2147483647),
...
(
    ...
    NOTE binary(2147483647),
    NONCE binary(32),
    TIMESTAMP integer NOT NULL,
    PENDING boolean NOT NULL,
    GOODS binary(2147483647),
    GOODS_NONCE binary(32),
    GOODS_IS_TEXT boolean DEFAULT TRUE NOT NULL,
    REFUND_NOTE binary(2147483647),
...
(
    DB_ID bigint  AUTO_INCREMENT PRIMARY KEY NOT NULL,
    ID bigint NOT NULL,
    FEEDBACK_DATA binary(2147483647) NOT NULL,
...
(
    DB_ID bigint AUTO_INCREMENT PRIMARY KEY NOT NULL,
    ID bigint NOT NULL,
    PUBLIC_FEEDBACK varchar(2147483647) NOT NULL,
    HEIGHT integer NOT NULL,
    LATEST boolean DEFAULT TRUE NOT NULL
);
...
CREATE INDEX IF NOT EXISTS SELL_OFFER_RATE_HEIGHT_IDX ON SELL_OFFER (RATE, CREATION_HEIGHT);
...
CREATE INDEX IF NOT EXISTS SHUFFLING_DATA_TRANSACTION_TIMESTAMP_IDX ON SHUFFLING_DATA (TRANSACTION_TIMESTAMP DESC);
...
(
    ...
    DATA binary(2147483647) NOT NULL,
...
(
    ...
    ATTACHMENT_BYTES binary(2147483647),
...
(
    ...
    TRANSACTION_BYTES binary(2147483647) NOT NULL,
    HEIGHT integer NOT NULL,
    PRUNABLE_JSON varchar(2147483647)
);
...
CREATE INDEX IF NOT EXISTS UNCONFIRMED_TRANSACTION_HEIGHT_FEE_TIMESTAMP_IDX ON UNCONFIRMED_TRANSACTION (TRANSACTION_HEIGHT, FEE_PER_BYTE DESC, ARRIVAL_TIMESTAMP);
...
(
    ...
    POLL_ID bigint NOT NULL,
    VOTER_ID bigint NOT NULL,
    VOTE_BYTES binary(2147483647) NOT NULL,
    HEIGHT integer NOT NULL
);
...
(
   ...
   ID                              BIGINT                NOT NULL,
   ACCOUNT_ID                      BIGINT                NOT NULL,
   CONTRACT_NAME                   VARCHAR(2147483647)   NOT NULL,
   CONTRACT_PARAMS                 VARCHAR(2147483647),
   CONTRACT_TRANSACTION_CHAIN_ID   INTEGER               NOT NULL,
   CONTRACT_TRANSACTION_FULL_HASH  VARBINARY,
   HEIGHT                          INTEGER               NOT NULL,
   LATEST                          BOOLEAN               DEFAULT TRUE NOT NULL
);

CREATE UNIQUE INDEX IF NOT EXISTS CONTRACT_REFERENCE_HEIGHT_ID_IDX
   ON CONTRACT_REFERENCE (HEIGHT ASC, ID ASC);

CREATE UNIQUE INDEX IF NOT EXISTS CONTRACT_REFERENCE_ID_HEIGHT_IDX
   ON CONTRACT_REFERENCE (ID ASC, HEIGHT DESC);

CREATE INDEX IF NOT EXISTS CONTRACT_REFERENCE_ACCOUNT_HEIGHT_IDX
...
CREATE INDEX IF NOT EXISTS COIN_ORDER_FXT_ACCOUNT_IDX
   ON COIN_ORDER_FXT (ACCOUNT_ID ASC);

CREATE INDEX IF NOT EXISTS COIN_ORDER_FXT_CHAIN_IDX
   ON COIN_ORDER_FXT (CHAIN_ID ASC, EXCHANGE_ID ASC);

CREATE INDEX IF NOT EXISTS COIN_ORDER_FXT_EXCHANGE_IDX
   ON COIN_ORDER_FXT (EXCHANGE_ID ASC);

CREATE UNIQUE INDEX IF NOT EXISTS COIN_ORDER_FXT_ID_IDX
...
(
   ...
   ORDER_FULL_HASH    VARBINARY   NOT NULL,
   MATCH_ID           BIGINT      NOT NULL,
   MATCH_FULL_HASH    VARBINARY   NOT NULL
);

CREATE INDEX  IF NOT EXISTS COIN_TRADE_FXT_EXCHANGE_IDX
   ON COIN_TRADE_FXT (EXCHANGE_ID ASC);

CREATE INDEX  IF NOT EXISTS COIN_TRADE_FXT_CHAIN_IDX
   ON COIN_TRADE_FXT (CHAIN_ID ASC);

CREATE INDEX  IF NOT EXISTS COIN_TRADE_FXT_ACCOUNT_IDX
   ON COIN_TRADE_FXT (ACCOUNT_ID ASC);

CREATE INDEX  IF NOT EXISTS COIN_TRADE_FXT_ORDER_IDX
...
CREATE UNIQUE INDEX IF NOT EXISTS  BALANCE_FXT_ID_HEIGHT_IDX
   ON BALANCE (ACCOUNT_ID ASC, HEIGHT DESC);

CREATE   INDEX IF NOT EXISTS BALANCE_FXT_HEIGHT_ID_IDX
...
CREATE INDEX  IF NOT EXISTS   ASSET_PROPERTY_ASSET_HEIGHT_IDX
   ON ASSET_PROPERTY (ASSET_ID ASC, HEIGHT DESC);

CREATE INDEX  IF NOT EXISTS   ASSET_PROPERTY_HEIGHT_ID_IDX
   ON ASSET_PROPERTY (HEIGHT ASC, ID ASC);

CREATE UNIQUE INDEX  IF NOT EXISTS   ASSET_PROPERTY_ID_HEIGHT_IDX
   ON ASSET_PROPERTY (ID ASC, HEIGHT DESC);

CREATE INDEX  IF NOT EXISTS   ASSET_PROPERTY_SETTER_PROPERTY_IDX
...
CREATE INDEX   IF NOT EXISTS ASSET_HISTORY_ACCOUNT_ID_IDX
...
CREATE INDEX   IF NOT EXISTS ASSET_HISTORY_HEIGHT_IDX
   ON ASSET_HISTORY (HEIGHT ASC);

CREATE INDEX   IF NOT EXISTS ASSET_HISTORY_ID_IDX
   ON ASSET_HISTORY (ID ASC);

CREATE UNIQUE INDEX   IF NOT EXISTS ASSET_HISTORY_ID_HEIGHT_IDX
   ON ASSET_HISTORY (ID ASC,HEIGHT ASC);
...
(
   ...
   MIN_BALANCE_MODEL             TINYINT,
   WHITELIST                     ARRAY,
   EXPRESSION                    VARCHAR(2147483647),
   SENDER_PROPERTY_SETTER_ID     BIGINT,
   SENDER_PROPERTY_NAME          VARCHAR(2147483647),
   SENDER_PROPERTY_VALUE         VARCHAR(2147483647),
   RECIPIENT_PROPERTY_SETTER_ID  BIGINT,
   RECIPIENT_PROPERTY_NAME       VARCHAR(2147483647),
   RECIPIENT_PROPERTY_VALUE      VARCHAR(2147483647),
   HEIGHT                        INTEGER               NOT NULL,
   LATEST                        BOOLEAN               DEFAULT TRUE NOT NULL
);


CREATE UNIQUE INDEX  IF NOT EXISTS   ASSET_CONTROL_PHASING_ID_HEIGHT_IDX
   ON ASSET_CONTROL_PHASING (ASSET_ID ASC, HEIGHT DESC);

CREATE INDEX  IF NOT EXISTS   ASSET_CONTROL_PHASING_HEIGHT_ID_IDX
...
CREATE INDEX  IF NOT EXISTS   ASSET_CONTROL_PHASING_SUB_POLL_ID_HEIGHT_IDX
   ON ASSET_CONTROL_PHASING_SUB_POLL (ASSET_ID ASC, HEIGHT DESC);

CREATE INDEX  IF NOT EXISTS    ASSET_CONTROL_PHASING_SUB_POLL_HEIGHT_ID_IDX
...
(
   DB_ID                  BIGINT      AUTO_INCREMENT PRIMARY KEY NOT NULL,
   HASHED_SECRET          VARBINARY   NOT NULL,
   HASHED_SECRET_ID       BIGINT      NOT NULL,
   ALGORITHM              TINYINT     NOT NULL,
   TRANSACTION_FULL_HASH  VARBINARY,
   TRANSACTION_ID         BIGINT      NOT NULL,
   CHAIN_ID               INTEGER     NOT NULL,
   FINISH_HEIGHT          INTEGER     NOT NULL,
   HEIGHT                 INTEGER     NOT NULL
...
CREATE UNIQUE INDEX IF NOT EXISTS   PHASING_POLL_HASHED_SECRET_ID_IX
   ON PHASING_POLL_HASHED_SECRET (HASHED_SECRET_ID ASC);

CREATE INDEX  IF NOT EXISTS    PHASING_POLL_HASHED_SECRET_HEIGHT_IDX
   ON PHASING_POLL_HASHED_SECRET (HEIGHT ASC);

CREATE INDEX IF NOT EXISTS    PHASING_POLL_HASHED_SECRET_TRANSACTION_ID_IDX
...
*/
/*SCAN表创建初始数据*/
MERGE INTO SCAN (   RESCAN,   HEIGHT,   VALIDATE ) KEY (HEIGHT) VALUES (   false,   0,   false );