...
(
 db_id NUMBER(19) GENERATED ALWAYS AS IDENTITY PRIMARY KEY NOT NULL,
 id BIGINT NOT NULL,
 balance BIGINT NOT NULL,
 unconfirmed_balance BIGINT NOT NULL,
 forged_balance BIGINT NOT NULL,
 active_lessee_id BIGINT,
 has_control_phasing NUMBER(1) DEFAULT FALSE NOT NULL,
 height INTEGER NOT NULL,
 latest NUMBER(1) DEFAULT TRUE NOT NULL
);
...
(
 ...
 price BIGINT NOT NULL,
 delisted NUMBER(1) NOT NULL,
 height INTEGER NOT NULL,
 latest NUMBER(1) DEFAULT TRUE NOT NULL,
 has_image NUMBER(1) DEFAULT FALSE NOT NULL
);
...
(
 ...
 recipient_id BIGINT,
 message BLOB,
 message_is_text NUMBER(1) NOT NULL,
 is_compressed NUMBER(1) NOT NULL,
 encrypted_message BLOB,
 encrypted_is_text NUMBER(1) DEFAULT FALSE,
...
(
 ...
 goods BLOB,
 goods_nonce BLOB,
 goods_is_text NUMBER(1) DEFAULT TRUE NOT NULL,
 refund_note BLOB,
 refund_nonce BLOB,
 has_feedback_notes NUMBER(1) DEFAULT FALSE NOT NULL,
 has_public_feedbacks NUMBER(1) DEFAULT FALSE NOT NULL,
...
(
 rescan NUMBER(1) DEFAULT FALSE NOT NULL,
 height INTEGER DEFAULT 0 NOT NULL,
 validate NUMBER(1) DEFAULT FALSE NOT NULL
);
...
(
 ...
 transaction_index SMALLINT NOT NULL,
 phased NUMBER(1) DEFAULT FALSE NOT NULL,
 attachment_bytes BLOB,
 version SMALLINT NOT NULL,
 has_message NUMBER(1) DEFAULT FALSE NOT NULL,
 has_encrypted_message NUMBER(1) DEFAULT FALSE NOT NULL,
 has_public_key_announcement NUMBER(1) DEFAULT FALSE NOT NULL,
 has_prunable_message NUMBER(1) DEFAULT FALSE NOT NULL,
 has_prunable_attachment NUMBER(1) DEFAULT FALSE NOT NULL,
 ec_block_height INTEGER DEFAULT NULL,
 ec_block_id BIGINT DEFAULT NULL,
 has_encrypttoself_message NUMBER(1) DEFAULT FALSE NOT NULL,
 has_prunable_encrypted_message NUMBER(1) DEFAULT FALSE NOT NULL,
...
/* 如果是历史库需要增加此字段
alter table asset add column has_control_phasing NUMBER(1) DEFAULT FALSE NOT NULL
*/
/*
