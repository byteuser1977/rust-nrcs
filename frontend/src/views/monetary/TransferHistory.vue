  ...
  <div class="page-container">
    ...
    <el-card shadow="hover" v-loading="loading">
      <el-table :data="items" stripe style="width:100%" :empty-text="t('common.noData')">
        <el-table-column prop="currency" :label="t('monetary.currency')" width="160" show-overflow-tooltip />
...
async function refreshData() {
  ...
  try {
    ...
    const result = await nrcsApi.getCurrencyTransfers(undefined, accountId, (page.value - 1) * 20, page.value * 20 - 1)
