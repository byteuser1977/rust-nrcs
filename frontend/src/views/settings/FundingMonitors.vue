<template>
  <div class="page-container">
    <div class="page-header">
      <h2 class="page-title"><el-icon><View /></el-icon> 资金监控</h2>
...
async function refreshData() {
  ...
  try {
    const result = await nrcsApi.getFundingMonitor(); items.value = (result.monitors || []).map((m: any) => ({ id: m.account, name: m.property })); total.value = items.value.length;
  } catch (error) {
