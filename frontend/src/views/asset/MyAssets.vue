<template>
  <div class="page-container">
    <div class="page-header">
      <h2 class="page-title"><el-icon><Wallet /></el-icon> 我的资产</h2>
...
async function refreshData() {
  ...
  try {
    const account = localStorage.getItem('nrcs_account_rs'); if (account) { const result = await nrcsApi.getAccountAssets(account); items.value = result.assetBalances || []; total.value = items.value.length; }
  } catch (error) {
