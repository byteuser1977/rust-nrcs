/**
 * NRCS 助记词单词列表（1626 词，与后端 words.rs 完全一致）
 *
 * 对应 Java: Constant.ALL_SECRET_PHRASE_WORDS
 * 对应 Rust: crates/crypto/src/passphrase/words.rs (NRCS_WORDS, WORD_COUNT=1626)
 * 对应 NRS 前端: js/crypto/passphrasegenerator.js
 *
 * 自动从后端 words.rs 提取生成，请勿手动修改。
 */

export const NRCS_WORDS: readonly string[] = [
...
/** 单词表长度（与后端 WORD_COUNT 一致） */
export const WORD_COUNT = 1626;
